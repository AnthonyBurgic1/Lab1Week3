...
let randomize = document.querySelector(".randomize"); // Use querySelector for the button class
let story = document.querySelector(".story"); // Target the paragraph with the "story" class
...
function result() {
  ...
  /* STEP 8: Use the randomValueFromArray() function to generate a value for 
    each of three new variables - xItem, yItem, and zItem Call up the function and for each variable, pass it the array from 
  ...
  /* STEP 9: Replace the three placeholders in the newStory 
    ...
    xItem, yItem, and zItem. */  //Each time, be sure to update the variable newStory (with =). You might need to do one of the above replacements twice! */
